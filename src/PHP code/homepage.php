...
<body>
    ...
    <form method = 'post'>
        ...
        <div class = "username-input" >
            ...
            <input class = "form-control" type = "text" name = "name" id = "name" placeholder = "Enter Username" required>
        <br>
        ...
        <select id = "position" name = "position" style = "text-align: center;" onchange = "location = this.value;">
